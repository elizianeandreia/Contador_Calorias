...
🎯 Como Funciona? <br>
1️⃣ O usuário insere o orçamento diário de calorias. <br>
2️⃣ Adiciona os alimentos consumidos ao longo do dia. <br>
3️⃣ Caso tenha feito exercícios, adiciona-os ao registro. <br>
4️⃣ Clica no botão "Calcular as calorias restantes" para visualizar o balanço calórico. <br>
5️⃣ O sistema exibe se houve superávit (excesso de calorias) ou déficit (consumo abaixo do orçamento). <br>
