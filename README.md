<strong>Contador de Calorias 🥗🔥</strong> <br>
...
JavaScript (Vanilla JS) → Manipulação do DOM e lógica do contador <br>
 ...
 Como Funciona? <br>
 O usuário insere o orçamento diário de calorias. <br>
 Adiciona os alimentos consumidos ao longo do dia. <br>
 Caso tenha feito exercícios, adiciona-os ao registro. <br>
 Clica no botão "Calcular as calorias restantes" para visualizar o balanço calórico. <br>
 O sistema exibe se houve superávit (excesso de calorias) ou déficit (consumo abaixo do orçamento). <br>
